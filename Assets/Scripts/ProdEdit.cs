...
public class ProdEdit : MonoBehaviour
{
    ...
    public static string objectOb; //Обозначение + наименование 
    public static string objectNa;
    ...
    public void UpdateItems()
    {
        ...
        using (var connection = new SqliteConnection(dbName))
        {
            ...
            {
                command.CommandText = "select * from Products o ";
    ...
    void InitializeItemView(GameObject viewGameObject, ItemModel model)
    {
        ...
        view.titleText2.text = model.title2;
        view.clickButton.onClick.AddListener(
            () =>
            {
                objectID = view.id;
                objectOb = view.titleText.text;
                objectNa = view.titleText2.text;
    ...
    public class ItemView
    {
        ...
        public ItemView(Transform rootView)
        {
            ...
            titleText2 = rootView.Find("TitleText2").GetComponent<Text>();
